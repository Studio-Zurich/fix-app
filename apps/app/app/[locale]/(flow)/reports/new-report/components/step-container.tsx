...
const StepContainer = ({
  ...
  return (
    <div
      className={cn(
        "flex-1 relative space-y-8  overflow-hidden flex flex-col",
        hideHeader ? "" : "max-h-[calc(100svh-60px)] px-[5vw] lg:px-6",
        className
      )}
    >
      {!hideHeader && (
      ...
      {children}
      <div className="fixed bottom-0 left-0 w-full bg-background h-min z-50">
        <div
